...
namespace ProlappApi.Controllers
{
    ...
    public class Factura3Controller : ApiController
    {
        ...
        public HttpResponseMessage GetFacturaCliente()
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes order by FechaDeExpedicion DESC";
        ...
        public HttpResponseMessage GetFacturaidCliente(int id)
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes where Factura3.IdCliente=" + id + "  order by FechaDeExpedicion DESC";
        ...
        public HttpResponseMessage GetFacturaClienteId(int id)
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes where id =" + id;
        ...
        public HttpResponseMessage GetFacturaFecha(string fechaini, string fechafinal)
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes where FechaDeExpedicion between '" + fechaini + "' and '" + fechafinal + " 23:59' and (Factura3.Estatus='Timbrada' or Factura3.Estatus='Pagada' or Factura3.Estatus='Cancelada') order by Factura3.folio asc";
        ...
        public HttpResponseMessage GetFacturaFechasReporte(int id, string fechaini, string fechafinal)
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes where Factura3.IdCliente = " + id + " and FechaDeExpedicion between '" + fechaini + "' and '" + fechafinal + " 23:59' and (Factura3.Estatus='Timbrada' or Factura3.Estatus='Pagada' or Factura3.Estatus='Cancelada') order by Factura3.folio asc";
        ...
        public HttpResponseMessage GetFacturaClienteFolio(int id)
        {
            ...
            string query = @"Select Factura3.* ,Cliente.* from Factura3 LEFT JOIN Cliente ON Factura3.IdCliente = Cliente.IdClientes where Folio =" + id;
        ...
        public HttpResponseMessage GetReporteM(int id)
        {
            ...
            query = @"select Factura3.Idcliente, Factura3.Folio, Factura3.Tipo, Factura3.FechaDeExpedicion, Factura3.FechaVencimiento, Factura3.Total, Factura3.Moneda, Factura3.TipoDeCambio, Factura3.TotalDlls, sum(convert(float,PagoCFDI.cantidad)) as pagos, sum(convert(float,NotaCredito.Total)) as NCTotal,sum(convert(float,NotaCredito.TotalDlls)) as NCTotalDlls from Factura3 left join PagoCFDI on Factura3.Id=PagoCFDI.IdFactura left join NotaCredito on NotaCredito.IdFactura=Factura3.Id where Factura3.IdCliente=" + id + " and Factura3.Moneda = 'USD' and Factura3.Estatus ='Timbrada' group by Factura3.Idcliente, Factura3.Folio, Factura3.Tipo, Factura3.FechaDeExpedicion, Factura3.FechaVencimiento, Factura3.Total, Factura3.Moneda, Factura3.TipoDeCambio, Factura3.TotalDlls order by Factura3.FechaDeExpedicion ";
        ...
        public HttpResponseMessage GetReporteU(int id)
        {
            ...
            query = @"select Factura3.Idcliente, Factura3.Folio, Factura3.Tipo, Factura3.FechaDeExpedicion, Factura3.FechaVencimiento, Factura3.Total, Factura3.Moneda, Factura3.TipoDeCambio, Factura3.TotalDlls, sum(convert(float,PagoCFDI.cantidad)) as pagos, sum(convert(float,NotaCredito.Total)) as NCTotal,sum(convert(float,NotaCredito.TotalDlls)) as NCTotalDlls from Factura3 left join PagoCFDI on Factura3.Id=PagoCFDI.IdFactura left join NotaCredito on NotaCredito.IdFactura=Factura3.Id where Factura.IdCliente=" + id + " and Factura3.Moneda = 'MXN' and Factura3.Estatus ='Timbrada' group by Factura3.Idcliente, Factura3.Folio, Factura3.Tipo, Factura3.FechaDeExpedicion, Factura3.FechaVencimiento, Factura3.Total, Factura3.Moneda, Factura3.TipoDeCambio, Factura3.TotalDlls order by Factura3.FechaDeExpedicion ";
            // string query = @"select Idcliente, Folio, Tipo, FechaDeExpedicion, Total, Moneda, TipoDeCambio from Factura where IdCliente= " + id + " union all select Idcliente, Folio, Tipo, FechaDeExpedicion, Total, Moneda, TipoDeCambio from NotaCredito where IdCliente= " + id + " order by FechaDeExpedicion desc ";
